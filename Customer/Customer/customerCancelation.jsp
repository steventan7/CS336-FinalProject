	...
	<div style="text-align:center;">
		<%	
		    ...
		    try {
		    	...
		    	if (econClass.equals("business") || econClass.equals("first")) {
		    		String r = "delete from ReservationPortfolioHas where accountId = " + session.getAttribute("accountid") + " and ticketNumber = " + ticketNumber + " and flight_number = " + flight_number + " and airline_id = '" + airline_id + "' and aircraft_id = " + aircraft_id;		
			        int delete1 = stmt.executeUpdate(r);
			        ...
			        int delete2 = stmt.executeUpdate(s);
			        int delete3 = stmt.executeUpdate("delete from flightticketreserve where ticketNumber = " + ticketNumber);
					out.print("<h1>You have successfully cancelled your flight!</h1>");
		    	} else {
		    		out.print("<h1>You must be business or first class to cancel your flight!</h1>");
